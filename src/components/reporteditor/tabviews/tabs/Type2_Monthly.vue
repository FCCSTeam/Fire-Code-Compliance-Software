...
import Modal_ELFPS_2_Monthly from "@/components/reporteditor/modals/type2/EmergencyLighting/Modal_ELFPS_2_Monthly.vue";

export default {
  components: {
    Entry,
    Modal_ELFPS_2_Monthly
  },
  props: {
    recordBook: {
      type: Object,
